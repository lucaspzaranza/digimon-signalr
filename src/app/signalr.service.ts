...
import {
  addPlayer, receivedChallengeAction, removePlayer, setDueling, setHP, setLocalPlayerCard,
  setLoser, setNetworkPlayerCard, setWaitingPlayerResponseAction, setWinner, updateLogAction
} from 'src/store/digi.actions';
import { Player } from 'src/models/player.model';
import { Router } from '@angular/router';
import {
  localCardSelector, localPlayerSelector, networkCardSelector,
  playerSelectorById, playersSelector, winnerSelector
} from 'src/store/digi.selector';
